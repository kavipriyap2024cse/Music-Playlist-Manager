...
public class MusicManager {
    static class Song {
        ...
        Song(String t, String a, double d, String g){ id=counter++; title=t; artist=a; duration=d; genre=g; }
        public String toString(){ return id+". "+title+" | "+artist+" | "+duration+" mins | "+genre; }
    }
    ...
    static void removeSong(){
        ...
        for(int i=0;i<playlist.size();i++){
            if(playlist.get(i).id==id){ playlist.remove(i); removed=true; break; }
        }
    ...
    static void savePlaylist(){
        System.out.print("Filename: "); String f=sc.nextLine();
